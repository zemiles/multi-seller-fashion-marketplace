...
ALTER TABLE marketplace.concept
    ADD CONSTRAINT fk_concept_taxonomy_version
    FOREIGN KEY (taxonomy_version_id)
    REFERENCES marketplace.concept_taxonomy_version (taxonomy_version_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.concept_alias
    ADD CONSTRAINT fk_concept_alias_concept
    FOREIGN KEY (concept_id) REFERENCES marketplace.concept (concept_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_analysis_run
    ADD CONSTRAINT fk_product_analysis_run_taxonomy
    FOREIGN KEY (taxonomy_version_id)
    REFERENCES marketplace.concept_taxonomy_version (taxonomy_version_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_concept
    ADD CONSTRAINT fk_product_concept_analysis_run
...
ALTER TABLE marketplace.product_concept
    ADD CONSTRAINT fk_product_concept_concept
    FOREIGN KEY (taxonomy_version_id, concept_id)
    REFERENCES marketplace.concept (taxonomy_version_id, concept_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_concept_evidence
    ADD CONSTRAINT fk_product_concept_evidence_concept
