...
CREATE TABLE marketplace.member_profile (
    ...
    -- A future-date check is request-time logic (CURRENT_DATE is not an immutable
    -- invariant). The database keeps only a stable lower-bound sanity check.
...
ALTER TABLE marketplace.member_auth_identity
    ADD CONSTRAINT fk_member_auth_identity_member
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id)
    ON DELETE CASCADE;

ALTER TABLE marketplace.member_profile
    ADD CONSTRAINT fk_member_profile_member
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id)
    ON DELETE CASCADE;

ALTER TABLE marketplace.shipping_address
    ADD CONSTRAINT fk_shipping_address_member
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id)
    ON DELETE CASCADE;

ALTER TABLE marketplace.seller_member
    ADD CONSTRAINT fk_seller_member_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_member
    ADD CONSTRAINT fk_seller_member_member
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_document
    ADD CONSTRAINT fk_seller_document_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_verification
    ADD CONSTRAINT fk_seller_verification_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_verification
    ADD CONSTRAINT fk_seller_verification_document
    FOREIGN KEY (document_id) REFERENCES marketplace.seller_document (document_id)
    ON DELETE SET NULL;

ALTER TABLE marketplace.seller_settlement_account
    ADD CONSTRAINT fk_seller_settlement_account_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_brand_relation
    ADD CONSTRAINT fk_seller_brand_relation_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_brand_relation
    ADD CONSTRAINT fk_seller_brand_relation_brand
    FOREIGN KEY (brand_id) REFERENCES marketplace.brand (brand_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.brand_registration_request
    ADD CONSTRAINT fk_brand_registration_request_seller
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.brand_registration_request
    ADD CONSTRAINT fk_brand_registration_request_approved_brand
    FOREIGN KEY (approved_brand_id) REFERENCES marketplace.brand (brand_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.brand_registration_request
    ADD CONSTRAINT fk_brand_registration_request_reviewer
...
ALTER TABLE marketplace.product
    ADD CONSTRAINT fk_product_seller_brand_relation
...
ALTER TABLE marketplace.product_revision
    ADD CONSTRAINT fk_product_revision_product
    FOREIGN KEY (product_id) REFERENCES marketplace.product (product_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_image
    ADD CONSTRAINT fk_product_image_product
    FOREIGN KEY (product_id) REFERENCES marketplace.product (product_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_revision
    ADD CONSTRAINT fk_product_revision_primary_image
...
ALTER TABLE marketplace.product_revision
    ADD CONSTRAINT fk_product_revision_creator
    FOREIGN KEY (created_by_seller_member_id)
    REFERENCES marketplace.seller_member (seller_member_id)
    ON DELETE SET NULL;

ALTER TABLE marketplace.product_feature
    ADD CONSTRAINT fk_product_feature_revision
    FOREIGN KEY (product_revision_id)
    REFERENCES marketplace.product_revision (product_revision_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.product_feature
    ADD CONSTRAINT fk_product_feature_confirmer
    FOREIGN KEY (confirmed_by_seller_member_id)
    REFERENCES marketplace.seller_member (seller_member_id)
    ON DELETE SET NULL;

ALTER TABLE marketplace.option_group
    ADD CONSTRAINT fk_option_group_product
    FOREIGN KEY (product_id) REFERENCES marketplace.product (product_id)
    ON DELETE RESTRICT;

ALTER TABLE marketplace.option_value
    ADD CONSTRAINT fk_option_value_group
...
ALTER TABLE marketplace.checkout_item
    ...
    ADD CONSTRAINT checkout_item_sku_fk
    FOREIGN KEY (sku_id) REFERENCES marketplace.sku (sku_id) ON DELETE RESTRICT,
    ADD CONSTRAINT checkout_item_product_revision_fk
    FOREIGN KEY (product_revision_id) REFERENCES marketplace.product_revision (product_revision_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.inventory_reservation
    ADD CONSTRAINT inventory_reservation_checkout_fk
    FOREIGN KEY (checkout_id) REFERENCES marketplace.checkout (checkout_id) ON DELETE CASCADE;

ALTER TABLE marketplace.inventory_reservation_item
    ADD CONSTRAINT inventory_reservation_item_reservation_fk
    FOREIGN KEY (reservation_id) REFERENCES marketplace.inventory_reservation (reservation_id) ON DELETE CASCADE,
    ADD CONSTRAINT inventory_reservation_item_sku_fk
    FOREIGN KEY (sku_id) REFERENCES marketplace.sku (sku_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.orders
    ADD CONSTRAINT orders_checkout_fk
    FOREIGN KEY (checkout_id) REFERENCES marketplace.checkout (checkout_id) ON DELETE RESTRICT,
    ADD CONSTRAINT orders_member_fk
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.order_shipping_group
    ADD CONSTRAINT order_shipping_group_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_shipping_group_checkout_group_fk
    FOREIGN KEY (checkout_shipping_group_id) REFERENCES marketplace.checkout_shipping_group (checkout_shipping_group_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_shipping_group_seller_fk
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.order_item
    ADD CONSTRAINT order_item_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_item_checkout_item_fk
    FOREIGN KEY (checkout_item_id) REFERENCES marketplace.checkout_item (checkout_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_item_shipping_group_fk
    ...
    ADD CONSTRAINT order_item_seller_fk
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_item_product_fk
    FOREIGN KEY (product_id) REFERENCES marketplace.product (product_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_item_product_revision_fk
    FOREIGN KEY (product_revision_id) REFERENCES marketplace.product_revision (product_revision_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_item_sku_fk
    FOREIGN KEY (sku_id) REFERENCES marketplace.sku (sku_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.order_charge
    ADD CONSTRAINT order_charge_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT,
    ADD CONSTRAINT order_charge_shipping_group_fk
    FOREIGN KEY (order_shipping_group_id) REFERENCES marketplace.order_shipping_group (order_shipping_group_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.order_state_event
    ADD CONSTRAINT order_state_event_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.shipment
    ADD CONSTRAINT shipment_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_order_shipping_group_fk
    FOREIGN KEY (order_shipping_group_id) REFERENCES marketplace.order_shipping_group (order_shipping_group_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_seller_fk
    FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.shipment_item
    ADD CONSTRAINT shipment_item_shipment_fk
    FOREIGN KEY (shipment_id) REFERENCES marketplace.shipment (shipment_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_item_order_item_fk
    FOREIGN KEY (order_item_id) REFERENCES marketplace.order_item (order_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_item_sku_fk
    FOREIGN KEY (sku_id) REFERENCES marketplace.sku (sku_id) ON DELETE RESTRICT,
    ADD CONSTRAINT shipment_item_exchange_line_fk
    FOREIGN KEY (exchange_line_id) REFERENCES marketplace.exchange_line (exchange_line_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.shipment_event
    ADD CONSTRAINT shipment_event_shipment_fk
    FOREIGN KEY (shipment_id) REFERENCES marketplace.shipment (shipment_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.purchase_confirmation_state
    ADD CONSTRAINT purchase_confirmation_state_shipment_item_fk
    FOREIGN KEY (shipment_item_id) REFERENCES marketplace.shipment_item (shipment_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.purchase_confirmation_event
    ADD CONSTRAINT purchase_confirmation_event_shipment_item_fk
    FOREIGN KEY (shipment_item_id) REFERENCES marketplace.shipment_item (shipment_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.purchase_confirmation_hold
    ADD CONSTRAINT purchase_confirmation_hold_shipment_item_fk
    FOREIGN KEY (shipment_item_id) REFERENCES marketplace.shipment_item (shipment_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT purchase_confirmation_hold_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim
    ADD CONSTRAINT claim_member_fk
    FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_order_fk
    FOREIGN KEY (order_id) REFERENCES marketplace.orders (order_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_item
    ADD CONSTRAINT claim_item_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_item_order_item_fk
    FOREIGN KEY (order_item_id) REFERENCES marketplace.order_item (order_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_item_source_allocation
    ADD CONSTRAINT claim_item_source_allocation_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_item_source_allocation_shipment_item_fk
    FOREIGN KEY (outbound_shipment_item_id) REFERENCES marketplace.shipment_item (shipment_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_evidence
    ADD CONSTRAINT claim_evidence_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_evidence_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_reason_change
    ADD CONSTRAINT claim_reason_change_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_review
    ADD CONSTRAINT claim_review_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_review_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.claim_event
    ADD CONSTRAINT claim_event_claim_fk
    FOREIGN KEY (claim_id) REFERENCES marketplace.claim (claim_id) ON DELETE RESTRICT,
    ADD CONSTRAINT claim_event_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.exchange_line
    ADD CONSTRAINT exchange_line_claim_item_fk
    FOREIGN KEY (claim_item_id) REFERENCES marketplace.claim_item (claim_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT exchange_line_replacement_sku_fk
    FOREIGN KEY (replacement_sku_id) REFERENCES marketplace.sku (sku_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.review_eligibility
    ADD CONSTRAINT fk_review_eligibility_order_item
        FOREIGN KEY (order_item_id) REFERENCES marketplace.order_item (order_item_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.review
    ADD CONSTRAINT fk_review_eligibility
        FOREIGN KEY (order_item_id)
        REFERENCES marketplace.review_eligibility (order_item_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_review_member
        FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.review_revision
    ADD CONSTRAINT fk_review_revision_review
        FOREIGN KEY (review_id) REFERENCES marketplace.review (review_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.review_image
    ADD CONSTRAINT fk_review_image_review
        FOREIGN KEY (review_id) REFERENCES marketplace.review (review_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_review_image_revision
        FOREIGN KEY (review_revision_id)
        REFERENCES marketplace.review_revision (review_revision_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_review_reply
    ADD CONSTRAINT fk_seller_review_reply_review
        FOREIGN KEY (review_id) REFERENCES marketplace.review (review_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_review_reply_member
        FOREIGN KEY (seller_member_id)
        REFERENCES marketplace.seller_member (seller_member_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.wishlist_item
...
ALTER TABLE marketplace.compliance_rule_version
    ADD CONSTRAINT fk_compliance_rule_version_rule
        FOREIGN KEY (compliance_rule_id)
        REFERENCES marketplace.compliance_rule (compliance_rule_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_compliance_rule_version_publisher
        FOREIGN KEY (published_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.product_compliance_finding
    ADD CONSTRAINT fk_product_compliance_revision
        FOREIGN KEY (product_revision_id)
        REFERENCES marketplace.product_revision (product_revision_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_product_compliance_rule_version
        FOREIGN KEY (rule_version_id)
        REFERENCES marketplace.compliance_rule_version (rule_version_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_product_compliance_decider
        FOREIGN KEY (decided_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_compliance_task
    ADD CONSTRAINT fk_seller_compliance_task_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_compliance_task_assignee
        FOREIGN KEY (assigned_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_compliance_task_item
    ADD CONSTRAINT fk_seller_compliance_task_item_task
        FOREIGN KEY (task_id)
        REFERENCES marketplace.seller_compliance_task (task_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_compliance_task_item_finding
        FOREIGN KEY (finding_id)
        REFERENCES marketplace.product_compliance_finding (finding_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.notification
    ADD CONSTRAINT fk_notification_member
        FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_notification_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.notification_preference
    ADD CONSTRAINT fk_notification_preference_member
        FOREIGN KEY (member_id) REFERENCES marketplace.member (member_id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_notification_preference_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE CASCADE;

ALTER TABLE marketplace.notification_delivery
...
ALTER TABLE marketplace.admin_user_role
    ...
    ADD CONSTRAINT fk_admin_user_role_grantor
        FOREIGN KEY (granted_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_admin_user_role_revoker
        FOREIGN KEY (revoked_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.admin_role_permission
    ...
    ADD CONSTRAINT fk_admin_role_permission_grantor
        FOREIGN KEY (granted_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.admin_approval_request
    ADD CONSTRAINT fk_admin_approval_request_maker
        FOREIGN KEY (requested_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.admin_approval_step
    ADD CONSTRAINT fk_admin_approval_step_request_maker
        FOREIGN KEY (approval_request_id, requester_admin_user_id)
        REFERENCES marketplace.admin_approval_request (
            approval_request_id, requested_by_admin_user_id
        ) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_admin_approval_step_approver
        FOREIGN KEY (approver_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.admin_audit_log
    ADD CONSTRAINT fk_admin_audit_log_user
        FOREIGN KEY (admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_admin_audit_log_approval
        FOREIGN KEY (approval_request_id)
        REFERENCES marketplace.admin_approval_request (approval_request_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_incident
    ADD CONSTRAINT fk_seller_incident_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_incident_finding
        FOREIGN KEY (finding_id)
        REFERENCES marketplace.product_compliance_finding (finding_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_penalty
    ADD CONSTRAINT fk_seller_penalty_incident
        FOREIGN KEY (incident_id)
        REFERENCES marketplace.seller_incident (incident_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_penalty_rule_version
        FOREIGN KEY (rule_version_id)
        REFERENCES marketplace.compliance_rule_version (rule_version_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_penalty_approver
        FOREIGN KEY (approved_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_health_metric
    ADD CONSTRAINT fk_seller_health_metric_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.seller_appeal
    ADD CONSTRAINT fk_seller_appeal_seller
        FOREIGN KEY (seller_id) REFERENCES marketplace.seller (seller_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_appeal_incident
        FOREIGN KEY (incident_id)
        REFERENCES marketplace.seller_incident (incident_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_appeal_penalty
        FOREIGN KEY (penalty_id)
        REFERENCES marketplace.seller_penalty (penalty_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_appeal_submitter
        FOREIGN KEY (submitted_by_seller_member_id)
        REFERENCES marketplace.seller_member (seller_member_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_seller_appeal_decider
        FOREIGN KEY (decided_by_admin_user_id)
        REFERENCES marketplace.admin_user (admin_user_id) ON DELETE RESTRICT;
