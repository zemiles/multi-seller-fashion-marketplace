...
주요 키/컬럼 최대10개 표시. 전체 컬럼/제약은 [서비스 데이터 사전](pg-naver-simulator.md), 영역 밖 FK는 서비스 DBML을 확인합니다.
