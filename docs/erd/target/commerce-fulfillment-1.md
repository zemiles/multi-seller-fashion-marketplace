...
erDiagram
    ...
    commerceClaimQuote["commerce.claim_quote"] {
        uuid quote_id PK "required"
        uuid order_id FK "required"
        uuid member_id FK "required"
        bigint order_version "required"
        text request_hash "required"
        jsonb quote_snapshot "required"
        timestamptz created_at "required"
        timestamptz expires_at "required"
    }
    commerceShipmentItemUnit["commerce.shipment_item_unit"] {
        uuid shipment_item_id PK, FK "required"
    ...
    commerceShipmentItem ||--o{ commerceShipmentItemUnit : "shipment_item_id"
```
