...
erDiagram
    ...
    paymentConsumerInbox["payment.consumer_inbox"] {
    ...
    paymentConsumerStreamCheckpoint["payment.consumer_stream_checkpoint"] {
        text consumer_name PK "required"
    ...
    paymentEventStreamSequence["payment.event_stream_sequence"] {
        text aggregate_type PK "required"
        text aggregate_id PK "required"
        bigint last_sequence "required"
        bigint version "required"
    }
    paymentEventRecoveryJob["payment.event_recovery_job"] {
    ...
    paymentOrderPaymentGuard["payment.order_payment_guard"] {
        uuid order_id PK "required"
        uuid active_attempt_id FK "nullable"
        uuid successful_payment_id FK "nullable"
        text gate "required"
        bigint version "required"
        text closed_reason "nullable"
        timestamptz updated_at "required"
    }
    ...
    paymentPaymentAttempt |o..o{ paymentOrderPaymentGuard : "active_attempt_id"
    paymentPayment |o..o{ paymentOrderPaymentGuard : "successful_payment_id"
```
