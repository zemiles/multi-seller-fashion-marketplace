...
ALTER TABLE marketplace.settlement_allocation
    ADD CONSTRAINT fk_settlement_allocation_settlement
        FOREIGN KEY (settlement_id) REFERENCES marketplace.settlement (settlement_id) ON DELETE RESTRICT,
    ADD CONSTRAINT fk_settlement_allocation_ledger
        FOREIGN KEY (seller_ledger_entry_id)
        REFERENCES marketplace.seller_ledger_entry (seller_ledger_entry_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.settlement_payout_attempt
    ADD CONSTRAINT fk_payout_attempt_settlement
        FOREIGN KEY (settlement_id) REFERENCES marketplace.settlement (settlement_id) ON DELETE RESTRICT;

ALTER TABLE marketplace.reconciliation_raw_row
    ADD CONSTRAINT fk_reconciliation_raw_file
